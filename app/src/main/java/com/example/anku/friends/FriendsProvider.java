...
import com.example.anku.friends.Exceptions.UnknownUri;
...
public class FriendsProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        openHelper = new FriendsDatabase(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            case FRIENDS:
                //do nothing as it's select * from table
                break;
            case FRIENDS_ID:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case FRIENDS:
                // do nothing - it update all rows of table
                break;
            case FRIENDS_ID:
                String id = FriendsContract.Friends.getFriendId(uri);
